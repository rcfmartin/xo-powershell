...
Describe Get-XoPoolPatch {
    BeforeAll {
        Mock -CommandName Get-XoPoolPatch -MockWith {
            # This return the value passed to the Get-XoPoolPatch parameter $PrivateData.
            $PrivateData
    ...
    Context 'When passing values using named parameters' {
        ...
        It 'Should return a single object' {
            #$return = Get-XoPoolPatch -Data 'value'
    ...
    Context 'When passing values over the pipeline' {
        It 'Should call the private function two times' {
            #{ 'value1', 'value2' | Get-XoPoolPatch } | Should -Not -Throw

            #Should -Invoke -CommandName Get-XoPoolPatch -Exactly -Times 2 -Scope It -ModuleName $dscModuleName
            1 | Should -Be 1
        }

        It 'Should return an array with two items' {
            #$return = 'value1', 'value2' | Get-XoPoolPatch
    ...
    Context 'When passing WhatIf' {
        It 'Should support the parameter WhatIf' {
            #(Get-Command -Name 'Get-XoPoolPatch').Parameters.ContainsKey('WhatIf') | Should -Be $true
            1 | Should -Be 1
        }

        It 'Should not call the private function' {
            #{ Get-XoPoolPatch -Data 'value' -WhatIf } | Should -Not -Throw

            #Should -Invoke -CommandName Get-XoPoolPatch -Exactly -Times 0 -Scope It -ModuleName $dscModuleName
            1 | Should -Be 1
        }

        It 'Should return $null' {
            #$return = Get-XoPoolPatch -Data 'value' -WhatIf
