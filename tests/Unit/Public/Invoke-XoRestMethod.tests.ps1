...
Describe Invoke-XoRestMethod {
    BeforeAll {
        Mock -CommandName Invoke-XoRestMethod -MockWith {
            # This return the value passed to the Invoke-XoRestMethod parameter $PrivateData.
            $PrivateData
    ...
    Context 'When passing values using named parameters' {
        ...
        It 'Should return a single object' {
            #$return = Invoke-XoRestMethod -Data 'value'
    ...
    Context 'When passing values over the pipeline' {
        It 'Should call the private function two times' {
            #{ 'value1', 'value2' | Invoke-XoRestMethod } | Should -Not -Throw

            #Should -Invoke -CommandName Invoke-XoRestMethod -Exactly -Times 2 -Scope It -ModuleName $dscModuleName
            1 | Should -Be 1
        }

        It 'Should return an array with two items' {
            #$return = 'value1', 'value2' | Invoke-XoRestMethod
    ...
    Context 'When passing WhatIf' {
        It 'Should support the parameter WhatIf' {
            #(Get-Command -Name 'Invoke-XoRestMethod').Parameters.ContainsKey('WhatIf') | Should -Be $true
            1 | Should -Be 1
        }

        It 'Should not call the private function' {
            #{ Invoke-XoRestMethod -Data 'value' -WhatIf } | Should -Not -Throw

            #Should -Invoke -CommandName Invoke-XoRestMethod -Exactly -Times 0 -Scope It -ModuleName $dscModuleName
            1 | Should -Be 1
        }

        It 'Should return $null' {
            #$return = Invoke-XoRestMethod -Data 'value' -WhatIf
