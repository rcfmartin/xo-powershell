...
Describe Test-XoSession {
    BeforeAll {
        Mock -CommandName Test-XoSession -MockWith {
            # This return the value passed to the Test-XoSession parameter $PrivateData.
            $PrivateData
    ...
    Context 'When passing values using named parameters' {
        ...
        It 'Should return a single object' {
            #$return = Test-XoSession -Data 'value'
    ...
    Context 'When passing values over the pipeline' {
        It 'Should call the private function two times' {
            #{ 'value1', 'value2' | Test-XoSession } | Should -Not -Throw

            #Should -Invoke -CommandName Test-XoSession -Exactly -Times 2 -Scope It -ModuleName $dscModuleName
            1 | Should -Be 1
        }

        It 'Should return an array with two items' {
            #$return = 'value1', 'value2' | Test-XoSession
    ...
    Context 'When passing WhatIf' {
        It 'Should support the parameter WhatIf' {
            #(Get-Command -Name 'Test-XoSession').Parameters.ContainsKey('WhatIf') | Should -Be $true
            1 | Should -Be 1
        }

        It 'Should not call the private function' {
            #{ Test-XoSession -Data 'value' -WhatIf } | Should -Not -Throw

            #Should -Invoke -CommandName Test-XoSession -Exactly -Times 0 -Scope It -ModuleName $dscModuleName
            1 | Should -Be 1
        }

        It 'Should return $null' {
            #$return = Test-XoSession -Data 'value' -WhatIf
