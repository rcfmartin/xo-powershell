...
```
Set-XoSrTag [-SrUuid] <String> [-Tag] <String> [-Remove] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

## DESCRIPTION
Manages individual tags on the specified storage repository using the /tags/{tag} endpoint.
