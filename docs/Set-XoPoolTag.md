...
```
Set-XoPoolTag [-PoolUuid] <String> [-Tag] <String> [-Remove] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

## DESCRIPTION
Manages individual tags on the specified pool using the /tags/{tag} endpoint.
