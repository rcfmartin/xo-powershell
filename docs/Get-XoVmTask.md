...
```
Get-XoVmTask [-VmUuid] <String[]> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

## DESCRIPTION
Retrieves tasks attached to the specified Xen Orchestra VM.
...
### -VmUuid
The UUID(s) of the VM whose tasks should be returned.
