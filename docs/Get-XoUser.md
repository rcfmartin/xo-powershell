...
### Filter (Default)
```
Get-XoUser [-Filter <String>] [-Limit <Int32>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### UserId
```
Get-XoUser [-UserId] <String[]> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
