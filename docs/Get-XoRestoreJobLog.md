...
### Filter (Default)
```
Get-XoRestoreJobLog [-Filter <String>] [-Limit <Int32>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### RestoreLogId
```
Get-XoRestoreJobLog [-RestoreLogId] <String[]> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
