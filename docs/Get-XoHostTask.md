...
```
Get-XoHostTask [-HostUuid] <String[]> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

## DESCRIPTION
Retrieves tasks attached to the specified Xen Orchestra host.
...
### -HostUuid
The UUID(s) of the host whose tasks should be returned.
