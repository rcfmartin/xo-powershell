...
```
Set-XoHostTag [-HostUuid] <String> [-Tag] <String> [-Remove] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

## DESCRIPTION
Manages individual tags on the specified host using the /tags/{tag} endpoint.
