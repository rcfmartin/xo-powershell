...
```
Get-XoVdiTask [-VdiUuid] <String[]> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

## DESCRIPTION
Retrieves tasks attached to the specified Xen Orchestra VDI.
...
### -VdiUuid
The UUID(s) of the VDI whose tasks should be returned.
